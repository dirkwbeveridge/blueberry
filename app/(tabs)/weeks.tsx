      ...
      >
        ...
        <Card style={styles.card}>
          <Section
            ...
            emoji="👶"
            content={content.babyDevelopment}
          />
        </Card>
        ...
        <Card style={styles.card}>
          <Section
            title="Mind & Body"
            emoji="🌿"
            content={content.mindAndBody}
          />
        </Card>

        {/* Partner note — shown to both roles */}
        ...
        {/* Quick stat from babyDevelopment */}
        <Card style={styles.card}>
...
const styles = StyleSheet.create({
  ...
  weekPill: {
    width: 44, height: 44, borderRadius: radii.md, backgroundColor: colors.background,
  ...
  heroCard: {
    ...
    borderRadius: radii.lg, padding: spacing.lg, borderWidth: 1.5,
  },
  heroLeft:      { gap: 2 },
