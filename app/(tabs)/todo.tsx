...
const styles = StyleSheet.create({
  ...
  loadingText:  { ...typography.body, fontSize: 14, lineHeight: 22, color: colors.textMuted, marginTop: spacing.md },
  subSectionLabel: { ...typography.label, fontSize: 12, fontFamily: fonts.body.semibold, color: colors.textMuted, letterSpacing: 1, textTransform: 'uppercase', marginBottom: spacing.md },
  // Todos
  ...
  checkmark:    { ...typography.label, fontFamily: fonts.body.semibold, color: colors.surface },
  todoBody:     { flex: 1, gap: 4 },
  todoTitle:    { ...typography.body, fontFamily: fonts.body.medium, color: colors.text, lineHeight: 22 },
  todoTitleDone:{ ...typography.body, color: colors.textMuted, textDecorationLine: 'line-through', flex: 1 },
  todoMeta:     { flexDirection: 'row', gap: spacing.xs, flexWrap: 'wrap', alignItems: 'center' },
  todoDue:      { ...typography.caption, color: colors.textMuted },
  priorityDot:  { width: 8, height: 8, borderRadius: 4, marginTop: 7 },
  doneToggle:   { paddingVertical: spacing.sm },
  doneToggleText: { ...typography.label, color: colors.textMuted },
  ...
  apptDateNum:  { ...typography.heading, fontSize: 18, lineHeight: 24, color: colors.primary },
  apptDateNumToday: { color: colors.surface },
  apptDateMon:  { ...typography.caption, fontFamily: fonts.body.semibold, fontSize: 9, lineHeight: 12, color: colors.textMuted, letterSpacing: 0.5 },
  ...
  apptDateNumPast: { ...typography.heading, fontSize: 18, lineHeight: 24, color: colors.textMuted },
  apptDateMonPast: { ...typography.caption, fontFamily: fonts.body.semibold, fontSize: 9, lineHeight: 12, color: colors.textMuted, letterSpacing: 0.5 },
  apptBody:     { flex: 1, gap: 2 },
  apptTitle:    { ...typography.body, fontFamily: fonts.body.semibold, color: colors.text },
  apptTitlePast:{ ...typography.body, fontFamily: fonts.body.semibold, color: colors.textMuted },
  apptTime:     { ...typography.caption, fontSize: 12, color: colors.textMuted },
  apptTimePast: { ...typography.caption, fontSize: 12, color: colors.textMuted },
  apptLocation: { ...typography.caption, fontSize: 12, color: colors.textMuted },
  apptLocationPast: { ...typography.caption, fontSize: 12, color: colors.textMuted },
  ...
  apptUrgencyText: { ...typography.caption, fontFamily: fonts.body.semibold, color: colors.primary },
  ...
  apptDeleteText: { ...typography.label, fontSize: 12, color: colors.textMuted },
  pastCard:     {},
  longPressHint:{ ...typography.caption, color: colors.textMuted, textAlign: 'center', marginTop: -spacing.xs },
});
