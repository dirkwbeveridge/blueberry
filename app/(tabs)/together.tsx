...
const styles = StyleSheet.create({
  ...
  focusCard: { backgroundColor: colors.primary, shadowColor: '#1A0F3A', shadowOpacity: 0.25, shadowRadius: 16, shadowOffset: { width:0, height:6 }, elevation: 6 },
  ...
  focusText: { fontFamily: fonts.body.regular, fontSize: 16, color: '#FFFFFF', lineHeight: 26 },
  ...
  promptCard:{ backgroundColor: '#F5F0FF', borderWidth: 1, borderColor: colors.accent },
